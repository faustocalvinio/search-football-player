...
function App() {
  ...
  return (
    ...
    <div className="flex flex-col max-w-[1300px] mx-auto py-10">
      ...
      <input ref={inputValue} type="text" placeholder="Search player" className="py-3 px-4 rounded-lg border-2 w-[80%] dark:bg-gray-200 dark:text-black dark:placeholder:text-black" />
      ...
      </form>
      {
        ...
        <div className="flex flex-row items-center justify-between">
          <h3 className="text-5xl text-white mx-0">{playerData.player[0].strNumber}</h3>
